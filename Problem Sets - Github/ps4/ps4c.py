...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        for letters in (VOWELS_LOWER, VOWELS_UPPER, CONSONANTS_LOWER, CONSONANTS_UPPER):
            i = 0
            for char in letters:
                if char in CONSONANTS_LOWER:
                    perms[char] = CONSONANTS_LOWER[i]
                elif char in CONSONANTS_UPPER:
                    perms[char] = CONSONANTS_UPPER[i]
                elif char in VOWELS_LOWER:
                    perms[char] = vowels_permutation[i]
                else:
                    perms[char] = vowels_permutation.upper()[i]
                i += 1
        return perms
